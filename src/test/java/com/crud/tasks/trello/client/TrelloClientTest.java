...
class TrelloClientTest {
    ...
    public void shouldCreateCard() throws URISyntaxException{
        ...
        CreatedTrelloCardDto createTrelloCard = new CreatedTrelloCardDto(
                "1",
                "Test task",
                "http://test.com"
        );
        when(restTemplate.postForObject(uri, null, CreatedTrelloCardDto.class)).thenReturn(createTrelloCard);
        //When
